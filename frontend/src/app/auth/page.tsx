...
export default function Login() {
  ...
  return (
    <main className="w-screen h-screen flex justify-center items-center bg-center bg-cover bg-[url('/auth_page_bg_light.png')] dark:bg-[url('/auth_page_bg_dark.png')]">
      ...
      >
        <div className="bg-auth_bg text-black dark:bg-auth_bg-dark dark:text-white w-full h-full rounded-3xl flex flex-col gap-14 p-5 lg:pt-10 xl:pt-16 items-center">
